...
| 2. | [Twitter spaces](https://t.ly/B7pin) | Announce partnerships, and demonstrate the extent of readiness of the frontend by interacting with all protocol functions. Minting is the only thing that may be done for the first 46 days after deployment (a private mempool or other form of MEV resistance is required for fair-launching in the full sense). |
